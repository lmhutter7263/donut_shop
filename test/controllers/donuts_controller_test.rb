...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { cost: @donut.cost, name: @donut.name, number: @donut.number, topping: @donut.topping }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { cost: @donut.cost, name: @donut.name, number: @donut.number, topping: @donut.topping }
    assert_redirected_to donut_path(assigns(:donut))
  end
